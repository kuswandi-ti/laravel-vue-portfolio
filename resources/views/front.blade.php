...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="{{ $about->photo }}" alt="" class="img-fluid rounded-circle">
        ...
        <div class="mt-4 text-light text-center">
          ...
          <a href="{{ $about->cv }}" class="btn btn-block btn-primary" target="_blank">Download CV</a>
        </div>
        ...
        <div class="social-links mt-4 text-center">
          <a href="https://www.facebook.com/kuswandi404/" class="facebook" target="_blank"><i class="bx bxl-facebook"></i></a>
          <a href="https://www.instagram.com/kuswandi0037" class="instagram" target="_blank"><i class="bx bxl-instagram"></i></a>
          <a href="https://www.linkedin.com/in/kuswandi-mr-a0068958/" class="linkedin" target="_blank"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#skills" class="nav-link scrollto"><i class='bx bx-cog'></i> <span>Skills</span></a></li>
      ...
      <div class="container">
          ...
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              @foreach($portfolio_categories as $category)
                <li data-filter=".filter-{{ strtolower($category->category_name) }}">{{ $category->category_name }}</li>
              @endforeach
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          @foreach($portfolios as $portfolio)
            <div class="col-lg-4 col-md-6 portfolio-item filter-{{ strtolower($portfolio->portfolio_category->category_name) }}">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="assets/img/portfolio/project.png" 
